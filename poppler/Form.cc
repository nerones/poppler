...
SignatureInfo *FormFieldSignature::validateSignature(bool doVerifyCert, bool forceRevalidation, time_t validationTime)
{
  ...
  signature_info->setSerialNumber(signature_handler.getSerialNumber());
  signature_info->setSignerCertNotBefore(signature_handler.getSignerCertNotBefore());
  signature_info->setSignerCertNotAfter(signature_handler.getSignerCertNotAfter());
